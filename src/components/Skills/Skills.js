  ...
  return (
    <section id='skills'>
      <div className='skillWrapper' >
        ...
        <div className='skillDesc' >Here are some of the skills I have acquired by doing certification courses and self-learning, demonstrating my dedication to continuous learning and growth.</div>
